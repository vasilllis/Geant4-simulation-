...
//    fNucFormfactor = fGaussianNF;
  
//  G4cout <<" AAA989898   fGaussianNF   " << G4endl;
...
//   21/11/2021    
    G4cout<<  "/n  BBBB**** WentzelVIRelXSection /n " <<G4endl;
  ...
  fNucFormfactor = G4EmParameters::Instance()->NuclearFormfactorType();
    G4cout<<  "/n  CCC**** WentzelVIRelXSection ===  fNucFormfactor:   /n "<<  fNucFormfactor   <<G4endl; 
...
//fNucFormfactor == fExponentialNF;
  ...
  if(cost1 > cost2) {
    ...
    if(fNucFormfactor == fExponentialNF) {
      fm += formf*z1;
      fm = 1.0/(fm*fm);
//          G4cout<<  "22222 fExponentialNF??? -- fExponentialNF???  fNucFormfactor:   /n "<<  fNucFormfactor   <<G4endl; 

//      fm = G4Exp(-2*formf*z1);
//          G4cout<<  "22222 fExponentialNF??? -- fGaussianNF???  fNucFormfactor:   /n "<<  fNucFormfactor   <<G4endl; 
      
    } else if(fNucFormfactor == fGaussianNF) {
      fm = G4Exp(-2*formf*z1);
//          G4cout<<  "8888 fGaussianNF???  fNucFormfactor:   /n "<<  fNucFormfactor   <<G4endl;       
...
//          G4cout<<  "7777 fFlatNF???  fNucFormfactor:   /n "<<  fNucFormfactor   <<G4endl; 	    
    }
    G4double grej;
    if(fMottXSection) {
